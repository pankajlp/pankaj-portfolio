      ...
      <article className="max-w-3xl mx-auto px-6 py-20">
        ...
        <section className="mt-14">
          <div className="overflow-x-auto rounded-2xl border border-white/10 bg-white/[0.03]">
            <table className="w-full text-left text-[15px] border-collapse">
              <thead>
                <tr className="border-b border-white/10 text-[#8a8175] text-[12px] uppercase tracking-wider">
              ...
              <tbody className="text-[#cfc7b6]">
                <tr className="border-b border-white/[0.06]">
                  <td className="py-4 px-5"><strong className="text-[#f2ede3]">A</strong> baseline</td>
                ...
                <tr className="border-b border-white/[0.06]">
                  <td className="py-4 px-5"><strong className="text-[#f2ede3]">B</strong> pure ledger</td>
                  <td className="py-4 px-5">0.684</td>
                  <td className="py-4 px-5">0</td>
                  <td className="py-4 px-5">0</td>
                  <td className="py-4 px-5">875k</td>
                </tr>
                <tr className="border-b border-white/[0.06] bg-white/[0.04]/70">
                  <td className="py-4 px-5"><strong className="text-[#f2ede3]">C</strong> governed</td>
                ...
                <tr className="border-b border-white/[0.06]">
                  <td className="py-4 px-5"><strong className="text-[#f2ede3]">C+</strong> +docket</td>
                ...
                <tr>
                  <td className="py-4 px-5"><strong className="text-[#f2ede3]">D</strong> +agent voice</td>
          ...
          <p className="mt-4 text-[13px] text-[#8a8175] leading-relaxed">
        ...
        <section className="mt-20">
          ...
          <div className="mt-8 space-y-7 text-[18px] leading-[2] text-[#efe9df]">
            ...
            <div className="border-l-[3px] border-white/15 pl-6 py-1 text-[17px] italic leading-[1.9] text-[#a89f8f]">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <p className="font-serif text-lg text-[#f2ede3]">LedgerBench is open</p>
            <p className="text-[#8a8175] text-sm mt-1">Harness, tasks, frozen results, and the full pre-registration.</p>
          </div>
          <a
            href="https://github.com/NordNeuron/ledgerbench"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#c8a86b] text-[#171310] text-[13px] font-medium hover:bg-[#d8bd86] transition-colors duration-300 shrink-0"
          >
        ...
        {/* Closing */}
        <div className="mt-12 border-l-[3px] border-white/10 pl-6 text-[18px] italic leading-[2] text-[#8a8175]">
