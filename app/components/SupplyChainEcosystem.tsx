...
export default function SupplyChainEcosystem() {
  return (
    <section className="relative py-32 px-6 md:px-10 bg-transparent overflow-hidden border-t border-stone-200">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold font-syne uppercase tracking-tight text-stone-900 leading-[1.02]">
            ...
            <span className="text-stone-400">Three Stages.</span>
          </h2>

          <p className="mt-6 text-base md:text-lg text-stone-500 leading-relaxed max-w-2xl font-light">
        ...
        {/* Flow */}
        <div className="mt-20 grid lg:grid-cols-3 gap-px bg-stone-200 border border-stone-200 rounded-3xl overflow-hidden">
          {stages.map((stage, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative bg-[#f5f4f0] hover:bg-white p-10 transition-colors duration-300"
            >
              {/* Stage header */}
              <div className="flex items-center justify-between mb-10">
                <span className="text-stone-400 font-syne text-xs font-bold tracking-[0.2em]">
                  {stage.number}
                </span>
                <span className="px-3.5 py-1 rounded-full border border-stone-300 text-[10px] uppercase font-syne tracking-widest text-stone-500">
                  {stage.label}
                </span>
              </div>
              ...
              {/* Feeds */}
              <div className="mt-8 space-y-2.5 border-t border-stone-200 pt-6">
                {stage.feeds.map((feed) => (
                  <div key={feed} className="flex items-center gap-3 text-stone-500 text-[11px] font-syne uppercase tracking-widest">
              ...
              {index < stages.length - 1 && (
                <div className="hidden lg:flex absolute top-1/2 -right-3 z-10 w-6 h-6 rounded-full bg-stone-900 items-center justify-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="mt-8 text-center text-stone-400 font-syne text-[10px] uppercase tracking-[0.3em]"
        >
