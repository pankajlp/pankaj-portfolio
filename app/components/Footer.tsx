...
export default function Footer() {
  return (
    <footer className="relative bg-[#0c0b0a] border-t border-white/[0.06] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 pt-16 pb-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-10 border-b border-white/[0.05]">
        ...
        {/* Nav links */}
        <div className="flex flex-wrap gap-8 font-mono text-[11px] uppercase tracking-widest text-[#a89f8f]">
          {[
            ...
            <TransitionLink
              key={link.label}
              href={link.href}
              className="hover:text-[#c8a86b] transition-colors duration-300"
            >
              {link.label}
            </TransitionLink>
          ))}
      ...
      {/* Bottom bar */}
      <div className="max-w-7xl mx-auto px-6 md:px-10 pb-10 flex flex-col md:flex-row items-center justify-between gap-3 text-[11px] text-[#8a8175] font-mono border-t border-white/[0.04] pt-6">
